...
class Database{
    ...
    function createTables(){
        $this->DB->query("CREATE TABLE songs(id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, artist_id INT NOT NULL, album_id INT, title VARCHAR(100), genre VARCHAR(100), `language` VARCHAR(100));");
        $this->DB->query("CREATE TABLE artists(id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, name VARCHAR(100), instrument VARCHAR(100), image MEDIUMBLOB);");
        $this->DB->query("CREATE TABLE albums(id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, name VARCHAR(100) NOT NULL, album_cover MEDIUMBLOB, release_date INT);");
    }
